...
lynx.initialize = function()
   -- Set Wallpaper
   gears.wallpaper.maximized(gears.filesystem.get_configuration_dir() .. "/wallpaper/lynx.png")

   -- Import components
   require("components.exit-screen")
   require("components.volume-adjust")
   require("components.lynx.titlebar")

   -- Import panels
   local left_panel = require("components.lynx.left-panel")
   local top_panel = require("components.lynx.top-panel")

   local icon_dir = gears.filesystem.get_configuration_dir() .. "/icons/tags/lynx/"
